...
-- Schedule contract-auto-reminder to run every hour (at minute 0)
SELECT cron.schedule(
  'contract-auto-reminder-hourly',
  '0 * * * *',
  $$
  SELECT net.http_post(
    url := 'https://qgenaltkjtlvwfgykpxq.supabase.co/functions/v1/contract-auto-reminder',
