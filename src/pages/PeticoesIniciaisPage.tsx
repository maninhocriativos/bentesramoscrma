...
export default function PeticoesIniciaisPage() {
  ...
  const {
    modelos, peticoesGeradas, loading: modelosLoading,
  ...
  const [mainTab, setMainTab] = useState('ia');
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground mt-0.5">
                Gere petições a partir de modelos DOCX ou com IA
              </p>
            </div>
          </div>
