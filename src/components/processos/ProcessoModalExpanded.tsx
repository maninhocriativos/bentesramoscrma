              ...
              {partes.length === 0 ? (
                <Card>
                  <CardContent className="py-8 text-center">
                    ...
                    <p className="text-xs text-muted-foreground mt-1">
                      Busque o processo pelo número para carregar as partes
                    </p>
                  </CardContent>
                </Card>
              ) : (
                      ...
                      <Card key={i}>
                        <CardContent className="p-3">
                          <div className="flex justify-between items-start gap-2">
                            ...
                            <Badge variant="outline" className={poloClasses}>{parte.tipo}</Badge>
                          </div>
                          {parte.documento && (
              ...
              {movimentos.length === 0 ? (
                <Card>
                  <CardContent className="py-8 text-center">
                    ...
                    <p className="text-xs text-muted-foreground mt-1">
                      Use o botão "Atualizar Status via DataJud" para carregar
                    </p>
                  </CardContent>
                </Card>
              ) : (
                      ...
                      {clienteSelecionado ? (
                        <>
                          <div className="p-3 bg-muted/50 rounded-lg text-sm">
                            ...
                            <p><strong>WhatsApp:</strong> {clienteSelecionado.telefone || 'Não informado'}</p>
                          </div>
                          <Button
                            onClick={handleSendNotification}
                            disabled={sendingNotification || !clienteSelecionado.telefone}
                            className="w-full rounded-xl"
                          >
                            {sendingNotification ? (
                              <Loader2 className="h-4 w-4 mr-2 animate-spin" />
