          ...
          <>
            ...
            <div className="h-[60px] px-4 flex items-center gap-3 bg-[#F0F2F5] dark:bg-[#202C33] border-b border-[#E9EDEF] dark:border-[#222D34]">
              ...
              <div className="flex items-center gap-1">
                {selectedSubscriber.telefone && (
                  <>
                    ...
                    <Button 
                      ...
                      className="h-10 w-10 rounded-full text-[#00A884] hover:bg-[#E9EDEF] dark:hover:bg-[#374248]"
                    ...
                    {/* Botão Chamada de Vídeo WhatsApp */}
                    <Button 
                      variant="ghost" 
                      size="icon" 
                      onClick={(e) => {
                ...
                <Button variant="ghost" size="icon" className="h-10 w-10 rounded-full text-[#54656F] dark:text-[#AEBAC1] hover:bg-[#E9EDEF] dark:hover:bg-[#374248]">
