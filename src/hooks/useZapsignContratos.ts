...
export type TipoOrigemZapsign = TipoOrigemLead;
...
// Classificação tráfego/escritório extraída para src/lib/leadOrigem.ts
// (reusada por useContratosFechados.ts, evita reescrever a mesma regra).
const classifyOrigem = classifyOrigemLead;
